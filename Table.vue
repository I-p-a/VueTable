      ...
      <template
        ...
        <tr>
          ...
          <td class="text-xs-right">
            <v-edit-dialog lazy>
              <p style='min-width: 20px;'>{{ props.item.count }}</p>
              <v-text-field
                slot="input"
                label="Edit"
          ...
          <td class="text-xs-right">
            <v-edit-dialog lazy>
              <p style='min-width: 20px;'>{{ props.item.price }}</p>
              <v-text-field
                slot="input"
                label="Edit"
          ...
          <v-card-title primary-title>
            ...
            <div>
              ...
              <v-text-field
                label="Count"
                type="number"
                v-model='newItem.count'></v-text-field>
              <v-text-field
                label="Price"
                type="number"
                v-model='newItem.price'></v-text-field>
            </div>
          </v-card-title>
          <v-card-actions>
            <v-btn
